...
export const appRouters = [
  {
    ...
    children: [
      ...
      {path: 'create', name: 'create', title: '新建工单', icon: 'mic-c', component: () => import('../components/ticket/Menu.vue')},
  ...
  //   component: LayOut,
  //   children: [
  //     {path: 'workflow', name: 'workflow', title: '流程管理', icon: 'network', component: () => import('../components/manage/Workflow.vue')},
  //     {path: 'log', name: 'log', title: '任务日志', icon: 'ios-book', component: () => import('../components/manage/Log.vue')}
  //   ],
  //   meta: {isAdmin: true}
  // }
]
